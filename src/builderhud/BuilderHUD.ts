...
export function initBuilderHud():BuilderHUD{
    var builderHud = new BuilderHUD()
    log("after hud")
    builderHud.pendingEntityAdd = new hudDelay(builderHud)
    engine.addSystem(builderHud.pendingEntityAdd)
